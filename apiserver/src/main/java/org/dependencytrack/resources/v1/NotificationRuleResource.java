...
public class NotificationRuleResource extends AbstractApiResource {
    ...
    public Response createNotificationRule(CreateNotificationRuleRequest request) {
        ...
        try (final var qm = new QueryManager(getAlpineRequest())) {
            updatedRule = qm.callInTransaction(() -> {
                ...
                if (ruleConfigSpec == null) {
                    ...
                    // TODO: Gracefully handle RuntimeConfigValidationException.
                    RuntimeConfigMapper.getInstance().validateJson(
                            request.publisherConfig(), ruleConfigSpec);
                }
