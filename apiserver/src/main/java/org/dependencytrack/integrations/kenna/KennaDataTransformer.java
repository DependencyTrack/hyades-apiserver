...
public class KennaDataTransformer {
    ...
    private final ArrayNode assets = Mappers.jsonMapper().createArrayNode();
    private final ArrayNode vulnDefs = Mappers.jsonMapper().createArrayNode();
     ...
     */
    private ObjectNode generateKdiVuln(final Vulnerability vulnerability, final AnalysisState analysisState) {
        final ObjectNode vuln = Mappers.jsonMapper().createObjectNode();
     ...
     */
    private ObjectNode generateKdiVulnDef(final Vulnerability vulnerability) {
        final ObjectNode vulnDef = Mappers.jsonMapper().createObjectNode();
