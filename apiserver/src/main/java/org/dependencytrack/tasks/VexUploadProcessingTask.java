...
public class VexUploadProcessingTask implements Subscriber {
    ...
    private final NotificationEmitter notificationEmitter = new KafkaNotificationEmitter();
    ...
    public void inform(final Event e) {
        if (e instanceof VexUploadEvent) {
            ...
            try(final QueryManager qm = new QueryManager()) {
                ...
                notificationEmitter.emit(createVexConsumedNotification(project, vexFormat, vexSpecVersion));
                qm.createVex(project, new Date(), vexFormat, vexSpecVersion, vexVersion, serialNumnber);
                notificationEmitter.emit(createVexProcessedNotification(project, vexFormat, vexSpecVersion));
            } catch (Exception ex) {
