...
import static org.dependencytrack.proto.workflow.payload.v1.CloneProjectArgs.Include.INCLUDE_ACL;
import static org.dependencytrack.proto.workflow.payload.v1.CloneProjectArgs.Include.INCLUDE_AUDIT_HISTORY;
import static org.dependencytrack.proto.workflow.payload.v1.CloneProjectArgs.Include.INCLUDE_COMPONENTS;
import static org.dependencytrack.proto.workflow.payload.v1.CloneProjectArgs.Include.INCLUDE_POLICY_VIOLATIONS;
import static org.dependencytrack.proto.workflow.payload.v1.CloneProjectArgs.Include.INCLUDE_PROPERTIES;
import static org.dependencytrack.proto.workflow.payload.v1.CloneProjectArgs.Include.INCLUDE_SERVICES;
import static org.dependencytrack.proto.workflow.payload.v1.CloneProjectArgs.Include.INCLUDE_TAGS;
import static org.dependencytrack.workflow.mapping.PayloadModelConverter.convertToProjectIdentity;

/**
 * @since 5.7.0
 */
@Activity(name = "clone-project", heartbeat = true)
public final class CloneProjectActivity implements ActivityExecutor<CloneProjectArgs, ProjectIdentity> {
    ...
    public ProjectIdentity execute(
            @NonNull final ActivityContext ctx,
        ...
        try {
            ...
            throw new TerminalApplicationFailureException("Failed to parse source project UUID", e);
        }
