...
public final class PublishNotificationWorkflow implements WorkflowExecutor<PublishNotificationWorkflowArg, Void> {
    ...
    public @Nullable Void execute(
        ...
        try (var ignoredMdcNotificationId = MDC.putCloseable(MDC_NOTIFICATION_ID, arg.getNotificationId())) {
            ...
            //
            // Note that activity failure are only logged, but don't lead to the entire
            // workflow failing. This is intentional for the moment because it's simple.
            //
            // If needed, we could decide whether to fail the workflow based on how many
            // of the scheduled activities failed.
