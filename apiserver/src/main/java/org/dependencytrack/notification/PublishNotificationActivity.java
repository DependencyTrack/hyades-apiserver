 ...
 * @since 5.7.0
 */
@Activity(name = "publish-notification", defaultTaskQueue = "notifications")
public final class PublishNotificationActivity implements ActivityExecutor<PublishNotificationActivityArg, Void> {
    ...
    private @Nullable RuntimeConfig getRuleConfig(
        ...
        try {
            ...
            throw new TerminalApplicationFailureException("""
                    Publisher configuration of the notification rule \
