...
public final class NotificationModelConverter {
    ...
    public static Group convert(final NotificationGroup group) {
        return switch (group) {
    ...
    public static Level convert(final NotificationLevel level) {
        return switch (level) {
    ...
    public static Scope convert(final NotificationScope scope) {
        return switch (scope) {
    ...
    public static UserSubject convert(final User user) {
    ...
    public static VulnerabilityAnalysis convert(final org.dependencytrack.model.Analysis analysis) {
