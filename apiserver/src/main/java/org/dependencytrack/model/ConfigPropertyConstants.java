...
public enum ConfigPropertyConstants {
    ...
    SBOM_PUSH("integrations", "sbom.push.enabled", "true", PropertyType.BOOLEAN, "Flag to enable/disable SBOM generation for GitLab projects", ConfigPropertyAccessMode.READ_WRITE),
