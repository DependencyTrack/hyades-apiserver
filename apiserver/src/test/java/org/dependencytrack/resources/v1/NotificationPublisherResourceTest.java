...
import org.dependencytrack.notification.DefaultNotificationPublisherSeeder;
...
class NotificationPublisherResourceTest extends ResourceTest {
    ...
    static void beforeAll() {
        ...
        pluginManager.loadPlugins(List.of(new DefaultNotificationPublisherPlugin()));
    }
    ...
    void getAllNotificationPublishersTest() {
        new DefaultNotificationPublisherSeeder().seedDefaultPublishers(pluginManager);
