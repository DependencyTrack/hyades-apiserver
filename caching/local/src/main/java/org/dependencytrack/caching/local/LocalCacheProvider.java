...
final class LocalCacheProvider implements CacheProvider {
    ...
    LocalCacheProvider(Config config) {
        this.config = config;
    ...
    private <V> Cache<V> createCache(String name) {
        ...
        final Caffeine<Object, Object> caffeineCacheBuilder = Caffeine.newBuilder();
        ...
        final com.github.benmanes.caffeine.cache.Cache<String, V> caffeineCache =
