...
public class SimilarityDist extends AbstractRoutine<Float> {
    ...
    public SimilarityDist() {
        super("similarity_dist", DefaultSchema.DEFAULT_SCHEMA, DSL.comment(""), SQLDataType.REAL);
     ...
     */
    public SimilarityDist set__1(Field<String> field) {
        setField(_1, field);
        return this;
    }
     ...
     * {@link org.jooq.Select} statement
     */
    public SimilarityDist set__2(Field<String> field) {
        setField(_2, field);
        return this;
    }
}
