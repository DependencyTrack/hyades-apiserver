...
public class WordSimilarityOp extends AbstractRoutine<Boolean> {
    ...
    /**
     * The parameter <code>word_similarity_op.RETURN_VALUE</code>.
     */
    public static final Parameter<Boolean> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>word_similarity_op._1</code>.
     */
    public static final Parameter<String> _1 = Internal.createParameter("_1", SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>word_similarity_op._2</code>.
     */
    ...
    public WordSimilarityOp() {
        super("word_similarity_op", DefaultSchema.DEFAULT_SCHEMA, DSL.comment(""), SQLDataType.BOOLEAN);
