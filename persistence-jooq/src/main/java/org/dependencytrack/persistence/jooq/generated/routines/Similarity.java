...
public class Similarity extends AbstractRoutine<Float> {
     ...
     */
    public Similarity() {
        super("similarity", DefaultSchema.DEFAULT_SCHEMA, DSL.comment(""), SQLDataType.REAL);
     ...
     */
    public Similarity set__1(Field<String> field) {
        setField(_1, field);
        return this;
    }
     ...
     * {@link org.jooq.Select} statement
     */
    public Similarity set__2(Field<String> field) {
        setField(_2, field);
        return this;
    }
}
