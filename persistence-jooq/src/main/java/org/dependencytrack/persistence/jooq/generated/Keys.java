...
public class Keys {
    ...
    public static final UniqueKey<UserProjectRolesRecord> USER_PROJECT_ROLES_PK = Internal.createUniqueKey(UserProjectRoles.USER_PROJECT_ROLES, DSL.name("USER_PROJECT_ROLES_PK"), new TableField[] { UserProjectRoles.USER_PROJECT_ROLES.id }, true);
