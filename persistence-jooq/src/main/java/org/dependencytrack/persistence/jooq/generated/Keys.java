...
public class Keys {
    ...
    public static final UniqueKey<DependencyMetricsRecord> DEPENDENCYMETRICS_PK = Internal.createUniqueKey(DependencyMetrics.DEPENDENCYMETRICS, DSL.name("DEPENDENCYMETRICS_PK"), new TableField[] { DependencyMetrics.DEPENDENCYMETRICS.projectId, DependencyMetrics.DEPENDENCYMETRICS.componentId, DependencyMetrics.DEPENDENCYMETRICS.lastOccurrence }, true);
    ...
    public static final UniqueKey<RolesPermissionsRecord> ROLES_PERMISSIONS_COMPOSITE_IDX = Internal.createUniqueKey(RolesPermissions.ROLES_PERMISSIONS, DSL.name("ROLES_PERMISSIONS_COMPOSITE_IDX"), new TableField[] { RolesPermissions.ROLES_PERMISSIONS.roleId, RolesPermissions.ROLES_PERMISSIONS.permissionId }, true);
    ...
    public static final ForeignKey<ProjectRoleBindingRecord, ProjectRecord> PROJECT_ROLE_BINDING_PROJECT_FK = Internal.createForeignKey(ProjectRoleBinding.PROJECT_ROLE_BINDING, DSL.name("PROJECT_ROLE_BINDING_PROJECT_FK"), new TableField[] { ProjectRoleBinding.PROJECT_ROLE_BINDING.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectRoleBindingRecord, RoleRecord> PROJECT_ROLE_BINDING_ROLE_FK = Internal.createForeignKey(ProjectRoleBinding.PROJECT_ROLE_BINDING, DSL.name("PROJECT_ROLE_BINDING_ROLE_FK"), new TableField[] { ProjectRoleBinding.PROJECT_ROLE_BINDING.roleId }, Keys.ROLE_PK, new TableField[] { Role.ROLE.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectRoleBindingRecord, UserRecord> PROJECT_ROLE_BINDING_USER_FK = Internal.createForeignKey(ProjectRoleBinding.PROJECT_ROLE_BINDING, DSL.name("PROJECT_ROLE_BINDING_USER_FK"), new TableField[] { ProjectRoleBinding.PROJECT_ROLE_BINDING.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
