...
import org.dependencytrack.persistence.jooq.generated.tables.records.RolesPermissionsRecord;
...
public class Keys {
    ...
    public static final UniqueKey<AnalysisRecord> ANALYSIS_COMPOSITE_IDX = Internal.createUniqueKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_COMPOSITE_IDX"), new TableField[] { Analysis.ANALYSIS.projectId, Analysis.ANALYSIS.componentId, Analysis.ANALYSIS.vulnerabilityId }, true);
    ...
    public static final UniqueKey<ApiKeysTeamsRecord> APIKEYS_TEAMS_PK = Internal.createUniqueKey(ApiKeysTeams.APIKEYS_TEAMS, DSL.name("APIKEYS_TEAMS_PK"), new TableField[] { ApiKeysTeams.APIKEYS_TEAMS.teamId, ApiKeysTeams.APIKEYS_TEAMS.apiKeyId }, true);
    ...
    public static final UniqueKey<DependencyMetricsRecord> DEPENDENCYMETRICS_PK = Internal.createUniqueKey(DependencyMetrics.DEPENDENCYMETRICS, DSL.name("DEPENDENCYMETRICS_PK"), new TableField[] { DependencyMetrics.DEPENDENCYMETRICS.componentId, DependencyMetrics.DEPENDENCYMETRICS.lastOccurrence }, true);
    ...
    public static final UniqueKey<MappedLdapGroupRecord> MAPPEDLDAPGROUP_U1 = Internal.createUniqueKey(MappedLdapGroup.MAPPEDLDAPGROUP, DSL.name("MAPPEDLDAPGROUP_U1"), new TableField[] { MappedLdapGroup.MAPPEDLDAPGROUP.teamId, MappedLdapGroup.MAPPEDLDAPGROUP.dn }, true);
    ...
    public static final UniqueKey<MappedOidcGroupRecord> MAPPEDOIDCGROUP_U1 = Internal.createUniqueKey(MappedOidcGroup.MAPPEDOIDCGROUP, DSL.name("MAPPEDOIDCGROUP_U1"), new TableField[] { MappedOidcGroup.MAPPEDOIDCGROUP.teamId, MappedOidcGroup.MAPPEDOIDCGROUP.groupId }, true);
    ...
    public static final UniqueKey<NotificationRuleTagsRecord> NOTIFICATIONRULE_TAGS_PK = Internal.createUniqueKey(NotificationRuleTags.NOTIFICATIONRULE_TAGS, DSL.name("NOTIFICATIONRULE_TAGS_PK"), new TableField[] { NotificationRuleTags.NOTIFICATIONRULE_TAGS.notificationRuleId, NotificationRuleTags.NOTIFICATIONRULE_TAGS.tagId }, true);
    public static final UniqueKey<NotificationRuleTeamsRecord> NOTIFICATIONRULE_TEAMS_PK = Internal.createUniqueKey(NotificationRuleTeams.NOTIFICATIONRULE_TEAMS, DSL.name("NOTIFICATIONRULE_TEAMS_PK"), new TableField[] { NotificationRuleTeams.NOTIFICATIONRULE_TEAMS.notificationRuleId, NotificationRuleTeams.NOTIFICATIONRULE_TEAMS.teamId }, true);
    ...
    public static final UniqueKey<PolicyTagsRecord> POLICY_TAGS_PK = Internal.createUniqueKey(PolicyTags.POLICY_TAGS, DSL.name("POLICY_TAGS_PK"), new TableField[] { PolicyTags.POLICY_TAGS.policyId, PolicyTags.POLICY_TAGS.tagId }, true);
    ...
    public static final UniqueKey<ProjectHierarchyRecord> PROJECT_HIERARCHY_PK = Internal.createUniqueKey(ProjectHierarchy.PROJECT_HIERARCHY, DSL.name("PROJECT_HIERARCHY_PK"), new TableField[] { ProjectHierarchy.PROJECT_HIERARCHY.parentProjectId, ProjectHierarchy.PROJECT_HIERARCHY.childProjectId }, true);
    ...
    public static final UniqueKey<ProjectMetricsRecord> PROJECTMETRICS_PK = Internal.createUniqueKey(ProjectMetrics.PROJECTMETRICS, DSL.name("PROJECTMETRICS_PK"), new TableField[] { ProjectMetrics.PROJECTMETRICS.projectId, ProjectMetrics.PROJECTMETRICS.lastOccurrence }, true);
    public static final UniqueKey<ProjectsTagsRecord> PROJECTS_TAGS_PK = Internal.createUniqueKey(ProjectsTags.PROJECTS_TAGS, DSL.name("PROJECTS_TAGS_PK"), new TableField[] { ProjectsTags.PROJECTS_TAGS.projectId, ProjectsTags.PROJECTS_TAGS.tagId }, true);
    ...
    public static final UniqueKey<RoleRecord> ROLE_NAME_IDX = Internal.createUniqueKey(Role.ROLE, DSL.name("ROLE_NAME_IDX"), new TableField[] { Role.ROLE.name }, true);
    ...
    public static final UniqueKey<RoleRecord> ROLE_UUID_IDX = Internal.createUniqueKey(Role.ROLE, DSL.name("ROLE_UUID_IDX"), new TableField[] { Role.ROLE.uuid }, true);
    public static final UniqueKey<RolesPermissionsRecord> ROLES_PERMISSIONS_PK = Internal.createUniqueKey(RolesPermissions.ROLES_PERMISSIONS, DSL.name("ROLES_PERMISSIONS_PK"), new TableField[] { RolesPermissions.ROLES_PERMISSIONS.roleId, RolesPermissions.ROLES_PERMISSIONS.permissionId }, true);
    ...
    public static final UniqueKey<TeamsPermissionsRecord> TEAMS_PERMISSIONS_PK = Internal.createUniqueKey(TeamsPermissions.TEAMS_PERMISSIONS, DSL.name("TEAMS_PERMISSIONS_PK"), new TableField[] { TeamsPermissions.TEAMS_PERMISSIONS.teamId, TeamsPermissions.TEAMS_PERMISSIONS.permissionId }, true);
    ...
    public static final UniqueKey<UserProjectEffectivePermissionsRecord> USER_PROJECT_EFFECTIVE_PERMISSIONS_PK = Internal.createUniqueKey(UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS, DSL.name("USER_PROJECT_EFFECTIVE_PERMISSIONS_PK"), new TableField[] { UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.projectId, UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.userId, UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.permissionId }, true);
    public static final UniqueKey<UserProjectRolesRecord> USER_PROJECT_ROLES_PK = Internal.createUniqueKey(UserProjectRoles.USER_PROJECT_ROLES, DSL.name("USER_PROJECT_ROLES_PK"), new TableField[] { UserProjectRoles.USER_PROJECT_ROLES.userId, UserProjectRoles.USER_PROJECT_ROLES.projectId, UserProjectRoles.USER_PROJECT_ROLES.roleId }, true);
    public static final UniqueKey<UsersPermissionsRecord> USERS_PERMISSIONS_PK = Internal.createUniqueKey(UsersPermissions.USERS_PERMISSIONS, DSL.name("USERS_PERMISSIONS_PK"), new TableField[] { UsersPermissions.USERS_PERMISSIONS.userId, UsersPermissions.USERS_PERMISSIONS.permissionId }, true);
    public static final UniqueKey<UsersTeamsRecord> USERS_TEAMS_PK = Internal.createUniqueKey(UsersTeams.USERS_TEAMS, DSL.name("USERS_TEAMS_PK"), new TableField[] { UsersTeams.USERS_TEAMS.userId, UsersTeams.USERS_TEAMS.teamId }, true);
    ...
    public static final UniqueKey<ViolationAnalysisRecord> VIOLATIONANALYSIS_COMPOSITE_IDX = Internal.createUniqueKey(ViolationAnalysis.VIOLATIONANALYSIS, DSL.name("VIOLATIONANALYSIS_COMPOSITE_IDX"), new TableField[] { ViolationAnalysis.VIOLATIONANALYSIS.projectId, ViolationAnalysis.VIOLATIONANALYSIS.componentId, ViolationAnalysis.VIOLATIONANALYSIS.policyViolationId }, true);
    ...
    public static final UniqueKey<VulnerabilitiesTagsRecord> VULNERABILITIES_TAGS_PK = Internal.createUniqueKey(VulnerabilitiesTags.VULNERABILITIES_TAGS, DSL.name("VULNERABILITIES_TAGS_PK"), new TableField[] { VulnerabilitiesTags.VULNERABILITIES_TAGS.vulnerabilityId, VulnerabilitiesTags.VULNERABILITIES_TAGS.tagId }, true);
    ...
    public static final ForeignKey<AnalysisRecord, ComponentRecord> ANALYSIS_COMPONENT_FK = Internal.createForeignKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_COMPONENT_FK"), new TableField[] { Analysis.ANALYSIS.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AnalysisRecord, ProjectRecord> ANALYSIS_PROJECT_FK = Internal.createForeignKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_PROJECT_FK"), new TableField[] { Analysis.ANALYSIS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AnalysisRecord, VulnerabilityRecord> ANALYSIS_VULNERABILITY_FK = Internal.createForeignKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_VULNERABILITY_FK"), new TableField[] { Analysis.ANALYSIS.vulnerabilityId }, Keys.VULNERABILITY_PK, new TableField[] { Vulnerability.VULNERABILITY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AnalysisRecord, VulnerabilityPolicyRecord> ANALYSIS_VULNERABILITY_POLICY_ID_FK = Internal.createForeignKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_VULNERABILITY_POLICY_ID_FK"), new TableField[] { Analysis.ANALYSIS.vulnerabilityPolicyId }, Keys.VULNERABILITYPOLICY_PK, new TableField[] { VulnerabilityPolicy.VULNERABILITY_POLICY.id }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AnalysisCommentRecord, AnalysisRecord> ANALYSISCOMMENT_ANALYSIS_FK = Internal.createForeignKey(AnalysisComment.ANALYSISCOMMENT, DSL.name("ANALYSISCOMMENT_ANALYSIS_FK"), new TableField[] { AnalysisComment.ANALYSISCOMMENT.analysisId }, Keys.ANALYSIS_PK, new TableField[] { Analysis.ANALYSIS.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ApiKeysTeamsRecord, ApiKeyRecord> APIKEYS_TEAMS_APIKEY_FK = Internal.createForeignKey(ApiKeysTeams.APIKEYS_TEAMS, DSL.name("APIKEYS_TEAMS_APIKEY_FK"), new TableField[] { ApiKeysTeams.APIKEYS_TEAMS.apiKeyId }, Keys.APIKEY_PK, new TableField[] { ApiKey.APIKEY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ApiKeysTeamsRecord, TeamRecord> APIKEYS_TEAMS_TEAM_FK = Internal.createForeignKey(ApiKeysTeams.APIKEYS_TEAMS, DSL.name("APIKEYS_TEAMS_TEAM_FK"), new TableField[] { ApiKeysTeams.APIKEYS_TEAMS.teamId }, Keys.TEAM_PK, new TableField[] { Team.TEAM.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<BomRecord, ProjectRecord> BOM_PROJECT_FK = Internal.createForeignKey(Bom.BOM, DSL.name("BOM_PROJECT_FK"), new TableField[] { Bom.BOM.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentRecord, ComponentRecord> COMPONENT_COMPONENT_FK = Internal.createForeignKey(Component.COMPONENT, DSL.name("COMPONENT_COMPONENT_FK"), new TableField[] { Component.COMPONENT.parentComponentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentRecord, LicenseRecord> COMPONENT_LICENSE_FK = Internal.createForeignKey(Component.COMPONENT, DSL.name("COMPONENT_LICENSE_FK"), new TableField[] { Component.COMPONENT.licenseId }, Keys.LICENSE_PK, new TableField[] { License.LICENSE.id }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentRecord, ProjectRecord> COMPONENT_PROJECT_FK = Internal.createForeignKey(Component.COMPONENT, DSL.name("COMPONENT_PROJECT_FK"), new TableField[] { Component.COMPONENT.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentOccurrenceRecord, ComponentRecord> COMPONENT_OCCURRENCE_COMPONENT_FK = Internal.createForeignKey(ComponentOccurrence.COMPONENT_OCCURRENCE, DSL.name("COMPONENT_OCCURRENCE_COMPONENT_FK"), new TableField[] { ComponentOccurrence.COMPONENT_OCCURRENCE.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentPropertyRecord, ComponentRecord> COMPONENT_PROPERTY_COMPONENT_ID_FK = Internal.createForeignKey(ComponentProperty.COMPONENT_PROPERTY, DSL.name("COMPONENT_PROPERTY_COMPONENT_ID_FK"), new TableField[] { ComponentProperty.COMPONENT_PROPERTY.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentsVulnerabilitiesRecord, ComponentRecord> COMPONENTS_VULNERABILITIES_COMPONENT_FK = Internal.createForeignKey(ComponentsVulnerabilities.COMPONENTS_VULNERABILITIES, DSL.name("COMPONENTS_VULNERABILITIES_COMPONENT_FK"), new TableField[] { ComponentsVulnerabilities.COMPONENTS_VULNERABILITIES.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentsVulnerabilitiesRecord, VulnerabilityRecord> COMPONENTS_VULNERABILITIES_VULNERABILITY_FK = Internal.createForeignKey(ComponentsVulnerabilities.COMPONENTS_VULNERABILITIES, DSL.name("COMPONENTS_VULNERABILITIES_VULNERABILITY_FK"), new TableField[] { ComponentsVulnerabilities.COMPONENTS_VULNERABILITIES.vulnerabilityId }, Keys.VULNERABILITY_PK, new TableField[] { Vulnerability.VULNERABILITY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<DependencyMetricsRecord, ComponentRecord> DEPENDENCYMETRICS_COMPONENT_FK = Internal.createForeignKey(DependencyMetrics.DEPENDENCYMETRICS, DSL.name("DEPENDENCYMETRICS_COMPONENT_FK"), new TableField[] { DependencyMetrics.DEPENDENCYMETRICS.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<DependencyMetricsRecord, ProjectRecord> DEPENDENCYMETRICS_PROJECT_FK = Internal.createForeignKey(DependencyMetrics.DEPENDENCYMETRICS, DSL.name("DEPENDENCYMETRICS_PROJECT_FK"), new TableField[] { DependencyMetrics.DEPENDENCYMETRICS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<FindingAttributionRecord, ProjectRecord> FINDINGATTRIBUTION_PROJECT_FK = Internal.createForeignKey(FindingAttribution.FINDINGATTRIBUTION, DSL.name("FINDINGATTRIBUTION_PROJECT_FK"), new TableField[] { FindingAttribution.FINDINGATTRIBUTION.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<FindingAttributionRecord, VulnerabilityRecord> FINDINGATTRIBUTION_VULNERABILITY_FK = Internal.createForeignKey(FindingAttribution.FINDINGATTRIBUTION, DSL.name("FINDINGATTRIBUTION_VULNERABILITY_FK"), new TableField[] { FindingAttribution.FINDINGATTRIBUTION.vulnerabilityId }, Keys.VULNERABILITY_PK, new TableField[] { Vulnerability.VULNERABILITY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<IntegrityAnalysisRecord, ComponentRecord> INTEGRITY_ANALYSIS_COMPONENT_FK = Internal.createForeignKey(IntegrityAnalysis.INTEGRITY_ANALYSIS, DSL.name("INTEGRITY_ANALYSIS_COMPONENT_FK"), new TableField[] { IntegrityAnalysis.INTEGRITY_ANALYSIS.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<LicenseGroupLicenseRecord, LicenseRecord> LICENSEGROUP_LICENSE_LICENSE_FK = Internal.createForeignKey(LicenseGroupLicense.LICENSEGROUP_LICENSE, DSL.name("LICENSEGROUP_LICENSE_LICENSE_FK"), new TableField[] { LicenseGroupLicense.LICENSEGROUP_LICENSE.licenseId }, Keys.LICENSE_PK, new TableField[] { License.LICENSE.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<LicenseGroupLicenseRecord, LicenseGroupRecord> LICENSEGROUP_LICENSE_LICENSEGROUP_FK = Internal.createForeignKey(LicenseGroupLicense.LICENSEGROUP_LICENSE, DSL.name("LICENSEGROUP_LICENSE_LICENSEGROUP_FK"), new TableField[] { LicenseGroupLicense.LICENSEGROUP_LICENSE.licenseGroupId }, Keys.LICENSEGROUP_PK, new TableField[] { LicenseGroup.LICENSEGROUP.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<MappedOidcGroupRecord, OidcGroupRecord> MAPPEDOIDCGROUP_OIDCGROUP_FK = Internal.createForeignKey(MappedOidcGroup.MAPPEDOIDCGROUP, DSL.name("MAPPEDOIDCGROUP_OIDCGROUP_FK"), new TableField[] { MappedOidcGroup.MAPPEDOIDCGROUP.groupId }, Keys.OIDCGROUP_PK, new TableField[] { OidcGroup.OIDCGROUP.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<MappedOidcGroupRecord, TeamRecord> MAPPEDOIDCGROUP_TEAM_FK = Internal.createForeignKey(MappedOidcGroup.MAPPEDOIDCGROUP, DSL.name("MAPPEDOIDCGROUP_TEAM_FK"), new TableField[] { MappedOidcGroup.MAPPEDOIDCGROUP.teamId }, Keys.TEAM_PK, new TableField[] { Team.TEAM.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<NotificationRuleProjectsRecord, NotificationRuleRecord> NOTIFICATIONRULE_PROJECTS_NOTIFICATIONRULE_FK = Internal.createForeignKey(NotificationRuleProjects.NOTIFICATIONRULE_PROJECTS, DSL.name("NOTIFICATIONRULE_PROJECTS_NOTIFICATIONRULE_FK"), new TableField[] { NotificationRuleProjects.NOTIFICATIONRULE_PROJECTS.notificationRuleId }, Keys.NOTIFICATIONRULE_PK, new TableField[] { NotificationRule.NOTIFICATIONRULE.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<NotificationRuleProjectsRecord, ProjectRecord> NOTIFICATIONRULE_PROJECTS_PROJECT_FK = Internal.createForeignKey(NotificationRuleProjects.NOTIFICATIONRULE_PROJECTS, DSL.name("NOTIFICATIONRULE_PROJECTS_PROJECT_FK"), new TableField[] { NotificationRuleProjects.NOTIFICATIONRULE_PROJECTS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<NotificationRuleTagsRecord, NotificationRuleRecord> NOTIFICATIONRULE_TAGS_NOTIFICATIONRULE_FK = Internal.createForeignKey(NotificationRuleTags.NOTIFICATIONRULE_TAGS, DSL.name("NOTIFICATIONRULE_TAGS_NOTIFICATIONRULE_FK"), new TableField[] { NotificationRuleTags.NOTIFICATIONRULE_TAGS.notificationRuleId }, Keys.NOTIFICATIONRULE_PK, new TableField[] { NotificationRule.NOTIFICATIONRULE.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<NotificationRuleTagsRecord, TagRecord> NOTIFICATIONRULE_TAGS_TAG_FK = Internal.createForeignKey(NotificationRuleTags.NOTIFICATIONRULE_TAGS, DSL.name("NOTIFICATIONRULE_TAGS_TAG_FK"), new TableField[] { NotificationRuleTags.NOTIFICATIONRULE_TAGS.tagId }, Keys.TAG_PK, new TableField[] { Tag.TAG.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<PolicyProjectsRecord, PolicyRecord> POLICY_PROJECTS_POLICY_FK = Internal.createForeignKey(PolicyProjects.POLICY_PROJECTS, DSL.name("POLICY_PROJECTS_POLICY_FK"), new TableField[] { PolicyProjects.POLICY_PROJECTS.policyId }, Keys.POLICY_PK, new TableField[] { Policy.POLICY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PolicyProjectsRecord, ProjectRecord> POLICY_PROJECTS_PROJECT_FK = Internal.createForeignKey(PolicyProjects.POLICY_PROJECTS, DSL.name("POLICY_PROJECTS_PROJECT_FK"), new TableField[] { PolicyProjects.POLICY_PROJECTS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PolicyTagsRecord, PolicyRecord> POLICY_TAGS_POLICY_FK = Internal.createForeignKey(PolicyTags.POLICY_TAGS, DSL.name("POLICY_TAGS_POLICY_FK"), new TableField[] { PolicyTags.POLICY_TAGS.policyId }, Keys.POLICY_PK, new TableField[] { Policy.POLICY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PolicyTagsRecord, TagRecord> POLICY_TAGS_TAG_FK = Internal.createForeignKey(PolicyTags.POLICY_TAGS, DSL.name("POLICY_TAGS_TAG_FK"), new TableField[] { PolicyTags.POLICY_TAGS.tagId }, Keys.TAG_PK, new TableField[] { Tag.TAG.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PolicyConditionRecord, PolicyRecord> POLICYCONDITION_POLICY_FK = Internal.createForeignKey(PolicyCondition.POLICYCONDITION, DSL.name("POLICYCONDITION_POLICY_FK"), new TableField[] { PolicyCondition.POLICYCONDITION.policyId }, Keys.POLICY_PK, new TableField[] { Policy.POLICY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PolicyViolationRecord, ComponentRecord> POLICYVIOLATION_COMPONENT_FK = Internal.createForeignKey(PolicyViolation.POLICYVIOLATION, DSL.name("POLICYVIOLATION_COMPONENT_FK"), new TableField[] { PolicyViolation.POLICYVIOLATION.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PolicyViolationRecord, PolicyConditionRecord> POLICYVIOLATION_POLICYCONDITION_FK = Internal.createForeignKey(PolicyViolation.POLICYVIOLATION, DSL.name("POLICYVIOLATION_POLICYCONDITION_FK"), new TableField[] { PolicyViolation.POLICYVIOLATION.policyConditionId }, Keys.POLICYCONDITION_PK, new TableField[] { PolicyCondition.POLICYCONDITION.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<PolicyViolationRecord, ProjectRecord> POLICYVIOLATION_PROJECT_FK = Internal.createForeignKey(PolicyViolation.POLICYVIOLATION, DSL.name("POLICYVIOLATION_PROJECT_FK"), new TableField[] { PolicyViolation.POLICYVIOLATION.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectRecord, ProjectRecord> PROJECT_PROJECT_FK = Internal.createForeignKey(Project.PROJECT, DSL.name("PROJECT_PROJECT_FK"), new TableField[] { Project.PROJECT.parentProjectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectAccessTeamsRecord, ProjectRecord> PROJECT_ACCESS_TEAMS_PROJECT_FK = Internal.createForeignKey(ProjectAccessTeams.PROJECT_ACCESS_TEAMS, DSL.name("PROJECT_ACCESS_TEAMS_PROJECT_FK"), new TableField[] { ProjectAccessTeams.PROJECT_ACCESS_TEAMS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectAccessTeamsRecord, TeamRecord> PROJECT_ACCESS_TEAMS_TEAM_FK = Internal.createForeignKey(ProjectAccessTeams.PROJECT_ACCESS_TEAMS, DSL.name("PROJECT_ACCESS_TEAMS_TEAM_FK"), new TableField[] { ProjectAccessTeams.PROJECT_ACCESS_TEAMS.teamId }, Keys.TEAM_PK, new TableField[] { Team.TEAM.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectHierarchyRecord, ProjectRecord> PROJECT_HIERARCHY_CHILD_PROJECT_FK = Internal.createForeignKey(ProjectHierarchy.PROJECT_HIERARCHY, DSL.name("PROJECT_HIERARCHY_CHILD_PROJECT_FK"), new TableField[] { ProjectHierarchy.PROJECT_HIERARCHY.childProjectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectHierarchyRecord, ProjectRecord> PROJECT_HIERARCHY_PARENT_PROJECT_FK = Internal.createForeignKey(ProjectHierarchy.PROJECT_HIERARCHY, DSL.name("PROJECT_HIERARCHY_PARENT_PROJECT_FK"), new TableField[] { ProjectHierarchy.PROJECT_HIERARCHY.parentProjectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectMetadataRecord, ProjectRecord> PROJECT_METADATA_PROJECT_ID_FK = Internal.createForeignKey(ProjectMetadata.PROJECT_METADATA, DSL.name("PROJECT_METADATA_PROJECT_ID_FK"), new TableField[] { ProjectMetadata.PROJECT_METADATA.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectPropertyRecord, ProjectRecord> PROJECT_PROPERTY_PROJECT_FK = Internal.createForeignKey(ProjectProperty.PROJECT_PROPERTY, DSL.name("PROJECT_PROPERTY_PROJECT_FK"), new TableField[] { ProjectProperty.PROJECT_PROPERTY.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectMetricsRecord, ProjectRecord> PROJECTMETRICS_PROJECT_FK = Internal.createForeignKey(ProjectMetrics.PROJECTMETRICS, DSL.name("PROJECTMETRICS_PROJECT_FK"), new TableField[] { ProjectMetrics.PROJECTMETRICS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectsTagsRecord, ProjectRecord> PROJECTS_TAGS_PROJECT_FK = Internal.createForeignKey(ProjectsTags.PROJECTS_TAGS, DSL.name("PROJECTS_TAGS_PROJECT_FK"), new TableField[] { ProjectsTags.PROJECTS_TAGS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectsTagsRecord, TagRecord> PROJECTS_TAGS_TAG_FK = Internal.createForeignKey(ProjectsTags.PROJECTS_TAGS, DSL.name("PROJECTS_TAGS_TAG_FK"), new TableField[] { ProjectsTags.PROJECTS_TAGS.tagId }, Keys.TAG_PK, new TableField[] { Tag.TAG.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<RolesPermissionsRecord, PermissionRecord> ROLES_PERMISSIONS_PERMISSION_FK = Internal.createForeignKey(RolesPermissions.ROLES_PERMISSIONS, DSL.name("ROLES_PERMISSIONS_PERMISSION_FK"), new TableField[] { RolesPermissions.ROLES_PERMISSIONS.permissionId }, Keys.PERMISSION_PK, new TableField[] { Permission.PERMISSION.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<RolesPermissionsRecord, RoleRecord> ROLES_PERMISSIONS_ROLE_FK = Internal.createForeignKey(RolesPermissions.ROLES_PERMISSIONS, DSL.name("ROLES_PERMISSIONS_ROLE_FK"), new TableField[] { RolesPermissions.ROLES_PERMISSIONS.roleId }, Keys.ROLE_PK, new TableField[] { Role.ROLE.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ServiceComponentRecord, ProjectRecord> SERVICECOMPONENT_PROJECT_FK = Internal.createForeignKey(ServiceComponent.SERVICECOMPONENT, DSL.name("SERVICECOMPONENT_PROJECT_FK"), new TableField[] { ServiceComponent.SERVICECOMPONENT.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ServiceComponentRecord, ServiceComponentRecord> SERVICECOMPONENT_SERVICECOMPONENT_FK = Internal.createForeignKey(ServiceComponent.SERVICECOMPONENT, DSL.name("SERVICECOMPONENT_SERVICECOMPONENT_FK"), new TableField[] { ServiceComponent.SERVICECOMPONENT.parentServiceComponentId }, Keys.SERVICECOMPONENT_PK, new TableField[] { ServiceComponent.SERVICECOMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ServiceComponentsVulnerabilitiesRecord, ServiceComponentRecord> SERVICECOMPONENTS_VULNERABILITIES_SERVICECOMPONENT_FK = Internal.createForeignKey(ServiceComponentsVulnerabilities.SERVICECOMPONENTS_VULNERABILITIES, DSL.name("SERVICECOMPONENTS_VULNERABILITIES_SERVICECOMPONENT_FK"), new TableField[] { ServiceComponentsVulnerabilities.SERVICECOMPONENTS_VULNERABILITIES.serviceComponentId }, Keys.SERVICECOMPONENT_PK, new TableField[] { ServiceComponent.SERVICECOMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ServiceComponentsVulnerabilitiesRecord, VulnerabilityRecord> SERVICECOMPONENTS_VULNERABILITIES_VULNERABILITY_FK = Internal.createForeignKey(ServiceComponentsVulnerabilities.SERVICECOMPONENTS_VULNERABILITIES, DSL.name("SERVICECOMPONENTS_VULNERABILITIES_VULNERABILITY_FK"), new TableField[] { ServiceComponentsVulnerabilities.SERVICECOMPONENTS_VULNERABILITIES.vulnerabilityId }, Keys.VULNERABILITY_PK, new TableField[] { Vulnerability.VULNERABILITY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TeamsPermissionsRecord, PermissionRecord> TEAMS_PERMISSIONS_PERMISSION_FK = Internal.createForeignKey(TeamsPermissions.TEAMS_PERMISSIONS, DSL.name("TEAMS_PERMISSIONS_PERMISSION_FK"), new TableField[] { TeamsPermissions.TEAMS_PERMISSIONS.permissionId }, Keys.PERMISSION_PK, new TableField[] { Permission.PERMISSION.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<TeamsPermissionsRecord, TeamRecord> TEAMS_PERMISSIONS_TEAM_FK = Internal.createForeignKey(TeamsPermissions.TEAMS_PERMISSIONS, DSL.name("TEAMS_PERMISSIONS_TEAM_FK"), new TableField[] { TeamsPermissions.TEAMS_PERMISSIONS.teamId }, Keys.TEAM_PK, new TableField[] { Team.TEAM.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectEffectivePermissionsRecord, PermissionRecord> USER_PROJECT_EFFECTIVE_PERMISSIONS_PERMISSION_ID_FK = Internal.createForeignKey(UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS, DSL.name("USER_PROJECT_EFFECTIVE_PERMISSIONS_PERMISSION_ID_FK"), new TableField[] { UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.permissionId }, Keys.PERMISSION_PK, new TableField[] { Permission.PERMISSION.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectEffectivePermissionsRecord, PermissionRecord> USER_PROJECT_EFFECTIVE_PERMISSIONS_PERMISSION_NAME_FK = Internal.createForeignKey(UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS, DSL.name("USER_PROJECT_EFFECTIVE_PERMISSIONS_PERMISSION_NAME_FK"), new TableField[] { UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.permissionName }, Keys.PERMISSION_IDX, new TableField[] { Permission.PERMISSION.name }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectEffectivePermissionsRecord, ProjectRecord> USER_PROJECT_EFFECTIVE_PERMISSIONS_PROJECT_FK = Internal.createForeignKey(UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS, DSL.name("USER_PROJECT_EFFECTIVE_PERMISSIONS_PROJECT_FK"), new TableField[] { UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectEffectivePermissionsRecord, UserRecord> USER_PROJECT_EFFECTIVE_PERMISSIONS_USER_FK = Internal.createForeignKey(UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS, DSL.name("USER_PROJECT_EFFECTIVE_PERMISSIONS_USER_FK"), new TableField[] { UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectRolesRecord, ProjectRecord> USER_PROJECT_ROLES_PROJECT_FK = Internal.createForeignKey(UserProjectRoles.USER_PROJECT_ROLES, DSL.name("USER_PROJECT_ROLES_PROJECT_FK"), new TableField[] { UserProjectRoles.USER_PROJECT_ROLES.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectRolesRecord, RoleRecord> USER_PROJECT_ROLES_ROLE_FK = Internal.createForeignKey(UserProjectRoles.USER_PROJECT_ROLES, DSL.name("USER_PROJECT_ROLES_ROLE_FK"), new TableField[] { UserProjectRoles.USER_PROJECT_ROLES.roleId }, Keys.ROLE_PK, new TableField[] { Role.ROLE.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectRolesRecord, UserRecord> USER_PROJECT_ROLES_USER_FK = Internal.createForeignKey(UserProjectRoles.USER_PROJECT_ROLES, DSL.name("USER_PROJECT_ROLES_USER_FK"), new TableField[] { UserProjectRoles.USER_PROJECT_ROLES.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersPermissionsRecord, PermissionRecord> USERS_PERMISSIONS_PERMISSION_FK = Internal.createForeignKey(UsersPermissions.USERS_PERMISSIONS, DSL.name("USERS_PERMISSIONS_PERMISSION_FK"), new TableField[] { UsersPermissions.USERS_PERMISSIONS.permissionId }, Keys.PERMISSION_PK, new TableField[] { Permission.PERMISSION.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersPermissionsRecord, UserRecord> USERS_PERMISSIONS_USER_FK = Internal.createForeignKey(UsersPermissions.USERS_PERMISSIONS, DSL.name("USERS_PERMISSIONS_USER_FK"), new TableField[] { UsersPermissions.USERS_PERMISSIONS.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersTeamsRecord, TeamRecord> USERS_TEAMS_TEAM_FK = Internal.createForeignKey(UsersTeams.USERS_TEAMS, DSL.name("USERS_TEAMS_TEAM_FK"), new TableField[] { UsersTeams.USERS_TEAMS.teamId }, Keys.TEAM_PK, new TableField[] { Team.TEAM.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersTeamsRecord, UserRecord> USERS_TEAMS_USER_FK = Internal.createForeignKey(UsersTeams.USERS_TEAMS, DSL.name("USERS_TEAMS_USER_FK"), new TableField[] { UsersTeams.USERS_TEAMS.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<VexRecord, ProjectRecord> VEX_PROJECT_FK = Internal.createForeignKey(Vex.VEX, DSL.name("VEX_PROJECT_FK"), new TableField[] { Vex.VEX.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ViolationAnalysisRecord, ComponentRecord> VIOLATIONANALYSIS_COMPONENT_FK = Internal.createForeignKey(ViolationAnalysis.VIOLATIONANALYSIS, DSL.name("VIOLATIONANALYSIS_COMPONENT_FK"), new TableField[] { ViolationAnalysis.VIOLATIONANALYSIS.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<ViolationAnalysisRecord, ProjectRecord> VIOLATIONANALYSIS_PROJECT_FK = Internal.createForeignKey(ViolationAnalysis.VIOLATIONANALYSIS, DSL.name("VIOLATIONANALYSIS_PROJECT_FK"), new TableField[] { ViolationAnalysis.VIOLATIONANALYSIS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ViolationAnalysisCommentRecord, ViolationAnalysisRecord> VIOLATIONANALYSISCOMMENT_VIOLATIONANALYSIS_FK = Internal.createForeignKey(ViolationAnalysisComment.VIOLATIONANALYSISCOMMENT, DSL.name("VIOLATIONANALYSISCOMMENT_VIOLATIONANALYSIS_FK"), new TableField[] { ViolationAnalysisComment.VIOLATIONANALYSISCOMMENT.violationAnalysisId }, Keys.VIOLATIONANALYSIS_PK, new TableField[] { ViolationAnalysis.VIOLATIONANALYSIS.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<VulnerabilitiesTagsRecord, TagRecord> VULNERABILITIES_TAGS_TAG_FK = Internal.createForeignKey(VulnerabilitiesTags.VULNERABILITIES_TAGS, DSL.name("VULNERABILITIES_TAGS_TAG_FK"), new TableField[] { VulnerabilitiesTags.VULNERABILITIES_TAGS.tagId }, Keys.TAG_PK, new TableField[] { Tag.TAG.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<VulnerabilitiesTagsRecord, VulnerabilityRecord> VULNERABILITIES_TAGS_VULNERABILITY_FK = Internal.createForeignKey(VulnerabilitiesTags.VULNERABILITIES_TAGS, DSL.name("VULNERABILITIES_TAGS_VULNERABILITY_FK"), new TableField[] { VulnerabilitiesTags.VULNERABILITIES_TAGS.vulnerabilityId }, Keys.VULNERABILITY_PK, new TableField[] { Vulnerability.VULNERABILITY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<VulnerableSoftwareVulnerabilitiesRecord, VulnerabilityRecord> VULNERABLESOFTWARE_VULNERABILITIES_VULNERABILITY_FK = Internal.createForeignKey(VulnerableSoftwareVulnerabilities.VULNERABLESOFTWARE_VULNERABILITIES, DSL.name("VULNERABLESOFTWARE_VULNERABILITIES_VULNERABILITY_FK"), new TableField[] { VulnerableSoftwareVulnerabilities.VULNERABLESOFTWARE_VULNERABILITIES.vulnerabilityId }, Keys.VULNERABILITY_PK, new TableField[] { Vulnerability.VULNERABILITY.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
