...
public class Keys {
    ...
    public static final ForeignKey<AnalysisRecord, ComponentRecord> ANALYSIS__ANALYSIS_COMPONENT_FK = Internal.createForeignKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_COMPONENT_FK"), new TableField[] { Analysis.ANALYSIS.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<AnalysisRecord, ProjectRecord> ANALYSIS__ANALYSIS_PROJECT_FK = Internal.createForeignKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_PROJECT_FK"), new TableField[] { Analysis.ANALYSIS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<AnalysisRecord, VulnerabilityPolicyRecord> ANALYSIS__ANALYSIS_VULNERABILITY_POLICY_ID_FK = Internal.createForeignKey(Analysis.ANALYSIS, DSL.name("ANALYSIS_VULNERABILITY_POLICY_ID_FK"), new TableField[] { Analysis.ANALYSIS.vulnerabilityPolicyId }, Keys.VULNERABILITYPOLICY_PK, new TableField[] { VulnerabilityPolicy.VULNERABILITY_POLICY.id }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<BomRecord, ProjectRecord> BOM__BOM_PROJECT_FK = Internal.createForeignKey(Bom.BOM, DSL.name("BOM_PROJECT_FK"), new TableField[] { Bom.BOM.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentRecord, ComponentRecord> COMPONENT__COMPONENT_COMPONENT_FK = Internal.createForeignKey(Component.COMPONENT, DSL.name("COMPONENT_COMPONENT_FK"), new TableField[] { Component.COMPONENT.parentComponentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentRecord, LicenseRecord> COMPONENT__COMPONENT_LICENSE_FK = Internal.createForeignKey(Component.COMPONENT, DSL.name("COMPONENT_LICENSE_FK"), new TableField[] { Component.COMPONENT.licenseId }, Keys.LICENSE_PK, new TableField[] { License.LICENSE.id }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentRecord, ProjectRecord> COMPONENT__COMPONENT_PROJECT_FK = Internal.createForeignKey(Component.COMPONENT, DSL.name("COMPONENT_PROJECT_FK"), new TableField[] { Component.COMPONENT.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<ComponentPropertyRecord, ComponentRecord> COMPONENT_PROPERTY__COMPONENT_PROPERTY_COMPONENT_ID_FK = Internal.createForeignKey(ComponentProperty.COMPONENT_PROPERTY, DSL.name("COMPONENT_PROPERTY_COMPONENT_ID_FK"), new TableField[] { ComponentProperty.COMPONENT_PROPERTY.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ComponentsVulnerabilitiesRecord, ComponentRecord> COMPONENTS_VULNERABILITIES__COMPONENTS_VULNERABILITIES_COMPONENT_FK = Internal.createForeignKey(ComponentsVulnerabilities.COMPONENTS_VULNERABILITIES, DSL.name("COMPONENTS_VULNERABILITIES_COMPONENT_FK"), new TableField[] { ComponentsVulnerabilities.COMPONENTS_VULNERABILITIES.componentId }, Keys.COMPONENT_PK, new TableField[] { Component.COMPONENT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<PolicyTagsRecord, TagRecord> POLICY_TAGS__POLICY_TAGS_TAG_FK = Internal.createForeignKey(PolicyTags.POLICY_TAGS, DSL.name("POLICY_TAGS_TAG_FK"), new TableField[] { PolicyTags.POLICY_TAGS.tagId }, Keys.TAG_PK, new TableField[] { Tag.TAG.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<ProjectRecord, ProjectRecord> PROJECT__PROJECT_PROJECT_FK = Internal.createForeignKey(Project.PROJECT, DSL.name("PROJECT_PROJECT_FK"), new TableField[] { Project.PROJECT.parentProjectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<ProjectHierarchyRecord, ProjectRecord> PROJECT_HIERARCHY__PROJECT_HIERARCHY_CHILD_PROJECT_FK = Internal.createForeignKey(ProjectHierarchy.PROJECT_HIERARCHY, DSL.name("PROJECT_HIERARCHY_CHILD_PROJECT_FK"), new TableField[] { ProjectHierarchy.PROJECT_HIERARCHY.childProjectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<ProjectMetadataRecord, ProjectRecord> PROJECT_METADATA__PROJECT_METADATA_PROJECT_ID_FK = Internal.createForeignKey(ProjectMetadata.PROJECT_METADATA, DSL.name("PROJECT_METADATA_PROJECT_ID_FK"), new TableField[] { ProjectMetadata.PROJECT_METADATA.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ProjectPropertyRecord, ProjectRecord> PROJECT_PROPERTY__PROJECT_PROPERTY_PROJECT_FK = Internal.createForeignKey(ProjectProperty.PROJECT_PROPERTY, DSL.name("PROJECT_PROPERTY_PROJECT_FK"), new TableField[] { ProjectProperty.PROJECT_PROPERTY.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<ProjectsTagsRecord, TagRecord> PROJECTS_TAGS__PROJECTS_TAGS_TAG_FK = Internal.createForeignKey(ProjectsTags.PROJECTS_TAGS, DSL.name("PROJECTS_TAGS_TAG_FK"), new TableField[] { ProjectsTags.PROJECTS_TAGS.tagId }, Keys.TAG_PK, new TableField[] { Tag.TAG.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<UserProjectEffectivePermissionsRecord, ProjectRecord> USER_PROJECT_EFFECTIVE_PERMISSIONS__USER_PROJECT_EFFECTIVE_PERMISSIONS_PROJECT_FK = Internal.createForeignKey(UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS, DSL.name("USER_PROJECT_EFFECTIVE_PERMISSIONS_PROJECT_FK"), new TableField[] { UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UserProjectEffectivePermissionsRecord, UserRecord> USER_PROJECT_EFFECTIVE_PERMISSIONS__USER_PROJECT_EFFECTIVE_PERMISSIONS_USER_FK = Internal.createForeignKey(UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS, DSL.name("USER_PROJECT_EFFECTIVE_PERMISSIONS_USER_FK"), new TableField[] { UserProjectEffectivePermissions.USER_PROJECT_EFFECTIVE_PERMISSIONS.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersPermissionsRecord, PermissionRecord> USERS_PERMISSIONS__USERS_PERMISSIONS_PERMISSION_FK = Internal.createForeignKey(UsersPermissions.USERS_PERMISSIONS, DSL.name("USERS_PERMISSIONS_PERMISSION_FK"), new TableField[] { UsersPermissions.USERS_PERMISSIONS.permissionId }, Keys.PERMISSION_PK, new TableField[] { Permission.PERMISSION.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersPermissionsRecord, UserRecord> USERS_PERMISSIONS__USERS_PERMISSIONS_USER_FK = Internal.createForeignKey(UsersPermissions.USERS_PERMISSIONS, DSL.name("USERS_PERMISSIONS_USER_FK"), new TableField[] { UsersPermissions.USERS_PERMISSIONS.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersTeamsRecord, TeamRecord> USERS_TEAMS__USERS_TEAMS_TEAM_FK = Internal.createForeignKey(UsersTeams.USERS_TEAMS, DSL.name("USERS_TEAMS_TEAM_FK"), new TableField[] { UsersTeams.USERS_TEAMS.teamId }, Keys.TEAM_PK, new TableField[] { Team.TEAM.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersTeamsRecord, UserRecord> USERS_TEAMS__USERS_TEAMS_USER_FK = Internal.createForeignKey(UsersTeams.USERS_TEAMS, DSL.name("USERS_TEAMS_USER_FK"), new TableField[] { UsersTeams.USERS_TEAMS.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<VexRecord, ProjectRecord> VEX__VEX_PROJECT_FK = Internal.createForeignKey(Vex.VEX, DSL.name("VEX_PROJECT_FK"), new TableField[] { Vex.VEX.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<VulnerabilitiesTagsRecord, TagRecord> VULNERABILITIES_TAGS__VULNERABILITIES_TAGS_TAG_FK = Internal.createForeignKey(VulnerabilitiesTags.VULNERABILITIES_TAGS, DSL.name("VULNERABILITIES_TAGS_TAG_FK"), new TableField[] { VulnerabilitiesTags.VULNERABILITIES_TAGS.tagId }, Keys.TAG_PK, new TableField[] { Tag.TAG.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
