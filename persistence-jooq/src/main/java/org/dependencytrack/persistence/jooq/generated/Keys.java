...
public class Keys {
    ...
    public static final ForeignKey<UsersProjectsRolesRecord, ProjectRecord> USERS_PROJECTS_ROLES_PROJECT_FK = Internal.createForeignKey(UsersProjectsRoles.USERS_PROJECTS_ROLES, DSL.name("USERS_PROJECTS_ROLES_PROJECT_FK"), new TableField[] { UsersProjectsRoles.USERS_PROJECTS_ROLES.projectId }, Keys.PROJECT_PK, new TableField[] { Project.PROJECT.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersProjectsRolesRecord, RoleRecord> USERS_PROJECTS_ROLES_ROLE_FK = Internal.createForeignKey(UsersProjectsRoles.USERS_PROJECTS_ROLES, DSL.name("USERS_PROJECTS_ROLES_ROLE_FK"), new TableField[] { UsersProjectsRoles.USERS_PROJECTS_ROLES.roleId }, Keys.ROLE_PK, new TableField[] { Role.ROLE.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<UsersProjectsRolesRecord, UserRecord> USERS_PROJECTS_ROLES_USER_FK = Internal.createForeignKey(UsersProjectsRoles.USERS_PROJECTS_ROLES, DSL.name("USERS_PROJECTS_ROLES_USER_FK"), new TableField[] { UsersProjectsRoles.USERS_PROJECTS_ROLES.userId }, Keys.USER_PK, new TableField[] { User.USER.id }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
