...
import static org.dependencytrack.workflow.engine.proto.v1alpha1.WorkflowRunStatus.WORKFLOW_RUN_STATUS_PENDING;
import static org.dependencytrack.workflow.engine.proto.v1alpha1.WorkflowRunStatus.WORKFLOW_RUN_STATUS_RUNNING;
import static org.dependencytrack.workflow.engine.proto.v1alpha1.WorkflowRunStatus.WORKFLOW_RUN_STATUS_SUSPENDED;
...
public enum WorkflowRunStatus {
    ...
    static WorkflowRunStatus fromProto(
            final org.dependencytrack.workflow.engine.proto.v1alpha1.WorkflowRunStatus protoStatus) {
    ...
    org.dependencytrack.workflow.engine.proto.v1alpha1.WorkflowRunStatus toProto() {
        return switch (this) {
