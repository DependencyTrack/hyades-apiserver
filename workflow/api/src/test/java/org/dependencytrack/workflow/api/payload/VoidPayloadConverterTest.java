...
class VoidPayloadConverterTest {

    private final VoidPayloadConverter converter = new VoidPayloadConverter();

    @Test
    void convertToPayloadShouldAlwaysReturnNull() {
        assertThat(converter.convertToPayload(null)).isNull();
    }

    @Test
    void convertFromPayloadShouldAlwaysReturnNull() {
