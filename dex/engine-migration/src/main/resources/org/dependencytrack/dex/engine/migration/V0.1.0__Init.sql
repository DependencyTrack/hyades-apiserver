...
create index dex_workflow_run_poll_idx
    on dex_workflow_run (priority desc, id, workflow_name)
...
begin
  ...
  select format('dex_activity_task_q_%s', left(normalized_queue_name, 38))
    into partition_name;
