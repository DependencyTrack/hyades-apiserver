...
import org.dependencytrack.server.EmbeddedJettyServer;
...
public final class DevServer {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try {
            ...
            final var postgresContainer = (AutoCloseable) postgresContainerConstructor.newInstance(config.getValue(DEV_SERVICES_IMAGE_POSTGRES.getPropertyName(), String.class));
            ...
            final var kafkaContainer = (AutoCloseable) kafkaContainerConstructor.newInstance(config.getValue(DEV_SERVICES_IMAGE_KAFKA.getPropertyName(), String.class));
            ...
            final var frontendContainer = (AutoCloseable) genericContainerConstructor.newInstance(config.getValue(DEV_SERVICES_IMAGE_FRONTEND.getPropertyName(), String.class));
        ...
        final Server server = EmbeddedJettyServer.create("0.0.0.0", 8080, "/");
        server.start();
        server.join();
    }
