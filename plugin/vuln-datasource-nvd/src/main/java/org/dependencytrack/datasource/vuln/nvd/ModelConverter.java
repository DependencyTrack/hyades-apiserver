...
import static org.cyclonedx.proto.v1_6.Classification.CLASSIFICATION_APPLICATION;
import static org.cyclonedx.proto.v1_6.Classification.CLASSIFICATION_DEVICE;
import static org.cyclonedx.proto.v1_6.Classification.CLASSIFICATION_NULL;
import static org.cyclonedx.proto.v1_6.Classification.CLASSIFICATION_OPERATING_SYSTEM;
        ...
        for (final CpeMatch cpeMatch : cpeMatches) {
            ...
            final Component component = componentByCpe.computeIfAbsent(
                    ...
                    cpeStr -> Component.newBuilder()
                            .setBomRef(UUID.randomUUID().toString())
