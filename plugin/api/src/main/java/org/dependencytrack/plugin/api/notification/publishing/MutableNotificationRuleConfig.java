...
public class MutableNotificationRuleConfig implements NotificationRuleConfig {
    ...
    private MutableNotificationRuleConfig(final Map<String, String> valueByName) {
        this.valueByName = requireNonNull(valueByName, "valueByName must not be null");
    }

    @SuppressWarnings({"rawtypes", "unchecked"})
    public static MutableNotificationRuleConfig ofDefaults(final NotificationPublisherFactory publisherFactory) {
    ...
    @Override
    public <T> Optional<T> getOptionalValue(final RuntimeConfigDefinition<T> configDef) {
    ...
    public <T> void setValue(final RuntimeConfigDefinition<T> configDef, final T value) {
