...
public final class RuntimeConfigSpec {
    ...
    public RuntimeConfigSpec(
        ...
        this.configClass = requireNonNull(configClass, "configClass must not be null");
    ...
    public RuntimeConfigSpec(
            Class<? extends RuntimeConfig> configClass,
            RuntimeConfig defaultConfig) {
        this(configClass, defaultConfig, new RuntimeConfigSchemaSource.Resource("runtime-config.schema.json"));
    }
