...
final class NvdVulnDataSourceFactory implements VulnDataSourceFactory {
    ...
    public RuntimeConfigSpec runtimeConfigSpec() {
        final var defaultConfig = new NVDVulnDataSourceConfig()
                .withEnabled(true)
                .withFeedsUrl(URI.create("https://nvd.nist.gov/feeds"));

        return new RuntimeConfigSpec(NVDVulnDataSourceConfig.class, defaultConfig);
    }
    ...
    public VulnDataSource create() {
        ...
        return new NvdVulnDataSource(watermarkManager, objectMapper, httpClient, config.getFeedsUrl().toString());
    }
