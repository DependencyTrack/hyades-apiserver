...
final class NvdVulnDataSourceFactory implements VulnDataSourceFactory {
    ...
    @Override
    public Class<NvdVulnDataSourceConfig> runtimeConfigClass() {
        return NvdVulnDataSourceConfig.class;
    }
    ...
    public RuntimeConfig defaultRuntimeConfig() {
        ...
        config.setFeedsUrl("https://nvd.nist.gov/feeds");
        return config;
    }
    ...
    public VulnDataSource create() {
        ...
        return new NvdVulnDataSource(watermarkManager, objectMapper, httpClient, config.getFeedsUrl());
    }
