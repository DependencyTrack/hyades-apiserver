...
final class NvdVulnDataSourceConfigs {
    ...
    static {
        // TODO: Set default values after https://github.com/DependencyTrack/hyades-apiserver/pull/1394 got merged.
        CONFIG_ENABLED = new RuntimeConfigDefinition<>(
                "enabled", "", ConfigTypes.BOOLEAN, false, false);
        CONFIG_FEEDS_URL = new RuntimeConfigDefinition<>(
                "feeds.url", "Base URL of NVD feeds", ConfigTypes.URL, true, false);
        CONFIG_WATERMARK = new RuntimeConfigDefinition<>(
                "watermark", "", ConfigTypes.INSTANT, false, false);
    }
