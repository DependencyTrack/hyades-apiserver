...
public final class PebbleTemplateRenderer implements TemplateRenderer {
    ...
    public PebbleTemplateRenderer(final Map<String, Supplier<Object>> contextVariableSuppliers) {
        this.pebbleEngine = new PebbleEngine.Builder()
                ...
                .build();
        this.contextVariableSuppliers = contextVariableSuppliers;
    }
    ...
    private static Message extractSubject(final Notification notification) throws IOException {
