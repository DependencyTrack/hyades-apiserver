...
class ConsoleNotificationPublisherFactoryTest {
    ...
    @Test
    void extensionNameShouldReturnConsole() {
        try (final var publisherFactory = new ConsoleNotificationPublisherFactory()) {
            assertThat(publisherFactory.extensionName()).isEqualTo("console");
        }
    }
    ...
    void extensionClassShouldReturnPublisherClass() {
        try (final var publisherFactory = new ConsoleNotificationPublisherFactory()) {
            assertThat(publisherFactory.extensionClass()).isEqualTo(ConsoleNotificationPublisher.class);
        }
    }
