...
final class OsvVulnDataSourceConfigs {
    ...
    static {
        ...
        CONFIG_DATA_URL = new RuntimeConfigDefinition<>(
                "data.url", "", ConfigTypes.URL, dataUrl, true, false);
        CONFIG_ECOSYSTEMS = new RuntimeConfigDefinition<>(
                "ecosystems", "", ConfigTypes.STRING_LIST, List.of("Go", "Maven", "npm", "NuGet", "PyPI"), false, false);
        CONFIG_WATERMARKS = new RuntimeConfigDefinition<>(
                "watermarks", "", ConfigTypes.STRING, null, false, false);
    }
