...
public class ConfigPropertyRuleTest {
    ...
    public void test() {
        ...
        assertEquals("local-baz", Config.getInstance().getDelegate().getValue("local.foo.bar", String.class));
        assertEquals("local-baz", Config.getInstance().getDelegate().getValue("lacol.oof.rab", String.class));
    }
