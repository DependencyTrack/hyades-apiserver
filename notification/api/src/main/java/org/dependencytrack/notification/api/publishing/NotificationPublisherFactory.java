...
public interface NotificationPublisherFactory extends ExtensionFactory<NotificationPublisher> {
     ...
     */
    default @Nullable String defaultTemplate() {
    ...
    /**
     * @return The MIME type of the default template. May be {@code null}
     * if {@link #defaultTemplate()} is also {@code null}.
     */
    @Nullable String defaultTemplateMimeType();
