...
public interface TemplateRenderer {
     ...
     */
    @Nullable RenderedTemplate render(Notification notification, @Nullable Map<String, Object> additionalContext);
     ...
     */
    default @Nullable RenderedTemplate render(Notification notification) {
