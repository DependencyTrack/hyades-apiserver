...
public class RetryablePublishException extends RuntimeException {
    ...
    public RetryablePublishException(
            ...
            final @Nullable Duration retryAfter) {
        super(message, cause);
        this.retryAfter = retryAfter;
    }

    public RetryablePublishException(final @Nullable String message, final @Nullable Throwable cause) {
        this(message, cause, null);
    }

    public RetryablePublishException(final @Nullable String message, final @Nullable Duration retryAfter) {
        this(message, null, retryAfter);
    }

    public RetryablePublishException(final @Nullable String message) {
