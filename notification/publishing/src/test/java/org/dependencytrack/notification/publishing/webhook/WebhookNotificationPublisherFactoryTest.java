...
class WebhookNotificationPublisherFactoryTest {
    ...
    @Test
    void extensionNameShouldReturnKafka() {
        try (final var publisherFactory = new WebhookNotificationPublisherFactory()) {
            assertThat(publisherFactory.extensionName()).isEqualTo("webhook");
        }
    }
    ...
    void extensionClassShouldReturnPublisherClass() {
        try (final var publisherFactory = new WebhookNotificationPublisherFactory()) {
            assertThat(publisherFactory.extensionClass()).isEqualTo(WebhookNotificationPublisher.class);
        }
    }
