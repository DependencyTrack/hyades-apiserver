...
import org.dependencytrack.notification.templating.pebble.PebbleTemplateRendererFactory;
...
public abstract class AbstractNotificationPublisherTest {
    ...
    protected void beforeEach() throws Exception {
        ...
        final var templateRendererFactory = new PebbleTemplateRendererFactory(
                Map.of("baseUrl", () -> "https://example.com"));
        final TemplateRenderer templateRenderer = templateRendererFactory.createRenderer(
                publisherFactory.defaultTemplate(),
                publisherFactory.defaultTemplateMimeType());
