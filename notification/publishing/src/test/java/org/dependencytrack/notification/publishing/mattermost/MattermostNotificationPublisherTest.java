...
class MattermostNotificationPublisherTest extends AbstractNotificationPublisherTest {
    ...
    protected NotificationPublisherFactory createPublisherFactory() {
        return new MattermostNotificationPublisherFactory();
    }

    @Override
    protected void customizeRuleConfig(RuntimeConfig ruleConfig) {
        final var httpRuleConfig = (HttpNotificationPublisherRuleConfig) ruleConfig;
