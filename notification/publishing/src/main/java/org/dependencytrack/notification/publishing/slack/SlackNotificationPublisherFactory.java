 ...
 * @since 5.7.0
 */
public final class SlackNotificationPublisherFactory implements NotificationPublisherFactory {
    ...
    public NotificationPublisher create() {
        ...
        return new SlackNotificationPublisher(httpClient);
    }

    @Override
    public RuntimeConfigSpec ruleConfigSpec() {
        return new RuntimeConfigSpec(
                new HttpNotificationPublisherRuleConfig()
