...
public final class PebbleTemplateRendererFactory {
    ...
    public PebbleTemplateRendererFactory(Map<String, Supplier<Object>> contextVariableSuppliers) {
    ...
    public TemplateRenderer createRenderer(@Nullable String template, @Nullable String mimeType) {
