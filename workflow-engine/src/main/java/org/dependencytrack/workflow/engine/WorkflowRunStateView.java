...
/**
 * A read-only view of a workflow run's state.
 */
public record WorkflowRunStateView(
        UUID id,
        String workflowName,
        int workflowVersion,
    ...
    static WorkflowRunStateView of(final WorkflowRunState state) {
        return new WorkflowRunStateView(
                state.id(),
                state.workflowName(),
