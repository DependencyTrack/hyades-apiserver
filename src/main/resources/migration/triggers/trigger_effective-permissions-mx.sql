...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_project_access_teams_insert
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_project_access_teams_delete
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_project_access_teams_update
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_ldapusers_teams_insert
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_ldapusers_teams_delete
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_ldapusers_teams_update
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_managedusers_teams_insert
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_managedusers_teams_delete
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_managedusers_teams_update
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_oidcusers_teams_insert
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_oidcusers_teams_delete
...
CREATE OR REPLACE TRIGGER trigger_effective_permissions_mx_on_oidcusers_teams_update
...
CREATE OR REPLACE TRIGGER trigger_prevent_direct_effective_permissions_writes
