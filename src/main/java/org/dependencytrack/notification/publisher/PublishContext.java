...
public class PublishContext {
    ...
    PublishContext(
            ...
            final Map<String, Object> notificationSubjects) {
    ...
    public static PublishContext fromNotification(final Notification notification) throws InvalidProtocolBufferException {
        ...
        if (notification.getSubject().is(BomConsumedOrProcessedSubject.class)) {
            ...
            notificationSubjects.put(SUBJECT_COMPONENT, Component.convert(subject.getComponent()));
            notificationSubjects.put(SUBJECT_PROJECT, Project.convert(subject.getProject()));
            if (subject.getVulnerabilitiesCount() > 0) {
        ...
        return new PublishContext(
                notification.getGroup().name(),
                notification.getLevel().name(),
                notification.getScope().name(),
                Timestamps.toString(notification.getTimestamp()),
