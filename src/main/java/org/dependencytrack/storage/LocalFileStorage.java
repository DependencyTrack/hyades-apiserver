...
final class LocalFileStorage implements FileStorage {
    ...
    @Override
    public FileMetadata store(final String fileName, final byte[] content) throws IOException {
        ...
        return FileMetadata.newBuilder()
                ...
                .putStorageMetadata(METADATA_KEY_SHA256_DIGEST, HexFormat.of().formatHex(contentDigest))
                .build();
    }
    ...
    public byte[] get(final FileMetadata fileMetadata) throws IOException {
        ...
        final String expectedContentDigestHex = fileMetadata.getStorageMetadataMap().get(METADATA_KEY_SHA256_DIGEST);
