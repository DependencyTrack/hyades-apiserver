 ...
 * This record defines the Vendor objects returned.
 * Record created to replace the model class defined here: <a href="https://github.com/stevespringett/vulndb-data-mirror">...</a>
 */
public record Vendor(int id, String name, String shortName, String vendorUrl,
                     List<Product> products) implements ApiObject {
}