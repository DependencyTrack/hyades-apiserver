...
public class IntegrityMetaInitializer implements ServletContextListener {
    ...
    private void dispatchPurls(QueryManager qm, List<String> purls) {
        for (final var purl : purls) {
            ...
            kafkaEventDispatcher.dispatchAsync(new ComponentRepositoryMetaAnalysisEvent(componentProjection.purlCoordinates, componentProjection.internal, FetchMeta.FETCH_META_INTEGRITY_DATA, FetchMeta.FETCH_META_UNSPECIFIED));
        }
    }
