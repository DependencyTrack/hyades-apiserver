...
public enum ConfigPropertyConstants {
    ...
    MAINTENANCE_INACTIVE_PROJECTS_RETENTION_DAYS("maintenance", "projects.retention.days", "30", PropertyType.INTEGER, "Number of days to retain inactive projects for", ConfigPropertyAccessMode.READ_WRITE),
    MAINTENANCE_INACTIVE_PROJECTS_RETENTION_TYPE("maintenance", "projects.retention.type", "AGE", PropertyType.STRING, "Retention policy type for inactive projects", ConfigPropertyAccessMode.READ_WRITE),
    MAINTENANCE_INACTIVE_PROJECTS_RETENTION_CADENCE("maintenance", "projects.retention.cadence", "2", PropertyType.INTEGER, "Number of last inactive projects to retain and delete rest", ConfigPropertyAccessMode.READ_WRITE),
