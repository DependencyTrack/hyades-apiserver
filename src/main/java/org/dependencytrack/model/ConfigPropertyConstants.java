...
public enum ConfigPropertyConstants {
    ...
    MAINTENANCE_PROJECTS_RETENTION_ENABLE("maintenance", "projects.retention.enable", "false", PropertyType.BOOLEAN, "Enable Inactive Project Deletion", ConfigPropertyAccessMode.READ_WRITE),
    ...
    MAINTENANCE_PROJECTS_RETENTION_TYPE("maintenance", "projects.retention.type", "AGE", PropertyType.STRING, "Retention policy type for inactive projects", ConfigPropertyAccessMode.READ_WRITE),
