...
import org.dependencytrack.common.NestSafeMdc;
...
abstract class AbstractApiResource extends AlpineResource {
    ...
    /**
     * TODO: Add a variant of this method that takes a Component.
     *
     ...
     */
    void requireProjectAccess(final QueryManager qm, final Project project) {
        ...
        if (!qm.hasAccess(super.getPrincipal(), project)) {
            try (var ignored = new NestSafeMdc(Map.ofEntries(
