-- ----------------------------------------------------------------
-- DataNucleus SchemaTool (ran at 17/11/2023 14:01:09)
-- ----------------------------------------------------------------
...
--
-- Table "WORKFLOW_STATE" for classes [org.dependencytrack.model.WorkflowState]
...
(
    ...
    "STATUS" varchar(64) NOT NULL CHECK ("STATUS" IN ('PENDING','TIMED_OUT','COMPLETED','FAILED','CANCELLED','NOT_APPLICABLE')),
    "STEP" varchar(64) NOT NULL CHECK ("STEP" IN ('BOM_CONSUMPTION','BOM_PROCESSING','VULN_ANALYSIS','REPO_META_ANALYSIS','POLICY_EVALUATION','METRICS_UPDATE')),
...
(
    ...
    "FAILURE_THRESHOLD" float8 NULL,
    "RECEIVED_RESULTS" int4 NOT NULL,
    "SCAN_FAILED" int8 NULL,
    "SCAN_TOTAL" int8 NULL,
...
-- Table "INTEGRITY_ANALYSIS" for classes [org.dependencytrack.model.IntegrityAnalysis]
CREATE TABLE "INTEGRITY_ANALYSIS"
(
    "ID" BIGSERIAL,
    "COMPONENT_ID" int8 NOT NULL,
    "INTEGRITY_CHECK_STATUS" varchar(255) NOT NULL,
    "MD5_HASH_MATCH_STATUS" varchar(255) NOT NULL,
    "SHA1_HASH_MATCH_STATUS" varchar(255) NOT NULL,
    "SHA256_HASH_MATCH_STATUS" varchar(255) NOT NULL,
    "SHA512_HASH_MATCH_STATUS" varchar(255) NOT NULL,
    "UPDATED_AT" timestamptz NOT NULL,
    CONSTRAINT "INTEGRITY_ANALYSIS_PK" PRIMARY KEY ("ID")
);
...
-- Table "INTEGRITY_META_COMPONENT" for classes [org.dependencytrack.model.IntegrityMetaComponent]
CREATE TABLE "INTEGRITY_META_COMPONENT"
(
    "ID" BIGSERIAL,
    "LAST_FETCH" timestamptz NULL,
    "MD5" varchar(32) NULL,
    ...
    "STATUS" varchar(64) NULL CHECK ("STATUS" IN ('PROCESSED','IN_PROGRESS','NOT_AVAILABLE') OR "STATUS" IS NULL),
    CONSTRAINT "INTEGRITY_META_COMPONENT_PK" PRIMARY KEY ("ID")
);
...
(
    ...
    "LOG_SUCCESSFUL_PUBLISH" bool NULL,
...
-- Constraints for table "WORKFLOW_STATE" for class(es) [org.dependencytrack.model.WorkflowState]
ALTER TABLE "WORKFLOW_STATE" ADD CONSTRAINT "WORKFLOW_STATE_COMPOSITE_IDX" UNIQUE ("TOKEN","STEP");

ALTER TABLE "WORKFLOW_STATE" ADD CONSTRAINT "WORKFLOW_STATE_FK1" FOREIGN KEY ("PARENT_STEP_ID") REFERENCES "WORKFLOW_STATE" ("ID") INITIALLY DEFERRED ;

CREATE INDEX "WORKFLOW_STATE_N49" ON "WORKFLOW_STATE" ("PARENT_STEP_ID");
...
-- Constraints for table "INTEGRITY_ANALYSIS" for class(es) [org.dependencytrack.model.IntegrityAnalysis]
ALTER TABLE "INTEGRITY_ANALYSIS" ADD CONSTRAINT "INTEGRITY_ANALYSIS_FK1" FOREIGN KEY ("COMPONENT_ID") REFERENCES "COMPONENT" ("ID") INITIALLY DEFERRED ;

CREATE INDEX "INTEGRITY_ANALYSIS_N49" ON "INTEGRITY_ANALYSIS" ("COMPONENT_ID");
...
CREATE INDEX "DEPENDENCYMETRICS_N49" ON "DEPENDENCYMETRICS" ("PROJECT_ID");
...
CREATE INDEX "DEPENDENCYMETRICS_N50" ON "DEPENDENCYMETRICS" ("COMPONENT_ID");
...
CREATE INDEX "ANALYSIS_N51" ON "ANALYSIS" ("PROJECT_ID");

CREATE INDEX "ANALYSIS_N50" ON "ANALYSIS" ("COMPONENT_ID");

CREATE INDEX "ANALYSIS_N49" ON "ANALYSIS" ("VULNERABILITY_ID");
...
CREATE INDEX "AFFECTEDVERSIONATTRIBUTION_N50" ON "AFFECTEDVERSIONATTRIBUTION" ("VULNERABILITY");

CREATE INDEX "AFFECTEDVERSIONATTRIBUTION_KEYS_IDX" ON "AFFECTEDVERSIONATTRIBUTION" ("VULNERABILITY","VULNERABLE_SOFTWARE");

CREATE INDEX "AFFECTEDVERSIONATTRIBUTION_N49" ON "AFFECTEDVERSIONATTRIBUTION" ("VULNERABLE_SOFTWARE");
...
CREATE INDEX "VIOLATIONANALYSIS_N50" ON "VIOLATIONANALYSIS" ("COMPONENT_ID");
...
CREATE INDEX "FINDINGATTRIBUTION_N51" ON "FINDINGATTRIBUTION" ("PROJECT_ID");
...
-- Constraints for table "INTEGRITY_META_COMPONENT" for class(es) [org.dependencytrack.model.IntegrityMetaComponent]
...
CREATE INDEX "SERVICECOMPONENT_N50" ON "SERVICECOMPONENT" ("PROJECT_ID");

CREATE INDEX "SERVICECOMPONENT_N49" ON "SERVICECOMPONENT" ("PARENT_SERVICECOMPONENT_ID");
...
CREATE INDEX "LDAPUSERS_PERMISSIONS_N50" ON "LDAPUSERS_PERMISSIONS" ("PERMISSION_ID");

CREATE INDEX "LDAPUSERS_PERMISSIONS_N49" ON "LDAPUSERS_PERMISSIONS" ("LDAPUSER_ID");
...
CREATE INDEX "NOTIFICATIONRULE_TEAMS_N50" ON "NOTIFICATIONRULE_TEAMS" ("TEAM_ID");

CREATE INDEX "NOTIFICATIONRULE_TEAMS_N49" ON "NOTIFICATIONRULE_TEAMS" ("NOTIFICATIONRULE_ID");
...
CREATE INDEX "PROJECTS_TAGS_N50" ON "PROJECTS_TAGS" ("TAG_ID");

CREATE INDEX "PROJECTS_TAGS_N49" ON "PROJECTS_TAGS" ("PROJECT_ID");
...
CREATE INDEX "MANAGEDUSERS_TEAMS_N50" ON "MANAGEDUSERS_TEAMS" ("MANAGEDUSER_ID");

CREATE INDEX "MANAGEDUSERS_TEAMS_N49" ON "MANAGEDUSERS_TEAMS" ("TEAM_ID");
