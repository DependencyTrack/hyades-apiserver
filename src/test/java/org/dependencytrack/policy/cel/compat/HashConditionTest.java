    ...
    private Object[] parameters() {
        return new Object[]{
                ...
                new Object[]{Policy.Operator.ANY, Operator.IS, "{ 'algorithm': 'test', 'value': 'test_hash' }",
                        "test_hash", false, ViolationState.INFO, Type.OPERATIONAL, ViolationState.INFO},
                new Object[]{Policy.Operator.ANY, Operator.IS_NOT, "{ 'algorithm': 'SHA256', 'value': 'test_hash' }",
                        "test_hash20", true, ViolationState.INFO, Type.OPERATIONAL, ViolationState.INFO},
                ...
                new Object[]{Policy.Operator.ANY, Operator.IS, "{ 'algorithm': null, 'value': 'test_hash' }",
                        "test_hash", false, ViolationState.FAIL, Type.OPERATIONAL, ViolationState.FAIL},
